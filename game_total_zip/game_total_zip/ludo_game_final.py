...
class ludoGame:
    ...
    def begin_game_start(self):
        ...
        top.iconbitmap("Images/game_board.ico")
...
if __name__ == '__main__':
    ...
    gamePage.iconbitmap("Images/game_board.ico")


    number6 = ImageTk.PhotoImage(Image.open("Images/number6.png").resize((33, 33)))
    number5 = ImageTk.PhotoImage(Image.open("Images/number5.png").resize((33, 33)))
    number4 = ImageTk.PhotoImage(Image.open("Images/number4.png").resize((33, 33)))
    number3 = ImageTk.PhotoImage(Image.open("Images/number3.png").resize((33, 33)))
    number2 = ImageTk.PhotoImage(Image.open("Images/number2.png").resize((33, 33)))
    number1 = ImageTk.PhotoImage(Image.open("Images/number1.png").resize((33, 33)))
